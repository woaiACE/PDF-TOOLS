...
class HomeView(QWidget):
    ...
    def init_ui(self):
        ...
        cards_data = [
            ...
            {"title": "压缩PDF", "desc": "减小PDF文件的尺寸，但同时保持最佳质量。优化您的PDF文件。", "icon": "🗜️", "active": False},
            {"title": "PDF 转换至 Word", "desc": "轻松地把PDF转换为可编辑的DOC和DOCX文件。转换后的WORD文件几乎100%正确。", "icon": "📝", "active": False},
            {"title": "PDF 转换至 PowerPoint", "desc": "将你的PDF转换为可编辑的PPT和PPTX幻灯片文件。", "icon": "📊", "active": False},
            {"title": "PDF 转换至 Excel", "desc": "只需几秒钟，即可将数据直接从PDF文件提取至Excel电子表格中。", "icon": "📈", "active": False},
            {"title": "Word转换至PDF文件", "desc": "将你的DOC或DOCX文件转换为PDF，以方便查看。", "icon": "🔄", "active": False},
            {"title": "PowerPoint 转换至 PDF", "desc": "将PPT转换为PDF文件，与原来的PPT或PPTX文件完全一样，并保持最佳质量。", "icon": "🔄", "active": False},
            {"title": "Excel 转换至 PDF", "desc": "把EXCEL表格转换为PDF文件，以方便查看。", "icon": "🔄", "active": False},
            {"title": "编辑PDF文件", "desc": "给PDF文件添加文本、图片、形状或手写的注释。编辑已添加内容的大小、字体和颜色。", "icon": "✏️", "active": False},
            {"title": "PDF转JPG", "desc": "提取PDF文件中的所有图片，或将每一页转换为JPG图片。", "icon": "🖼️", "active": False},
            {"title": "JPG转PDF", "desc": "将您的图片转换为PDF文件，还可以调整方向和边距。", "icon": "🖼️", "active": False},
        ]
        row, col = 0, 0
